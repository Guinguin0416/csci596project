...
where *N* is the total number of atoms, $W=L_xL_yL_z$ is the volume of the simulation box, $r_{i}^{\alpha\beta}$is the $\alpha$-th component of the vector $r_{ij} = r_i − r_j$ , and u(r) is the is the Lennard-Jones potential function.
